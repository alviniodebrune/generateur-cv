...
export function layoutChronologique(C, data, photoSrc, A) {
...
export function layoutSidebar(C, data, photoSrc, A) {
  const { Document, Page, Text, View, StyleSheet, Image } = C;
  const { skillsList, languagesList, experiences, education, contactParts } = prepareData(data);
  const s = StyleSheet.create({
...
export function layoutEuropass(C, data, photoSrc, A) {
  const { Document, Page, Text, View, StyleSheet, Image } = C;
  const { skillsList, languagesList, experiences, education, contactParts } = prepareData(data);
  const s = StyleSheet.create({
...
export function layoutEtudiant(C, data, photoSrc, A) {
  const { Document, Page, Text, View, StyleSheet, Image } = C;
  const { skillsList, languagesList, experiences, education, contactParts } = prepareData(data);
  const s = StyleSheet.create({
